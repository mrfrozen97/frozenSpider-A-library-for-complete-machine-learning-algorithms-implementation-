...
class Loss :
    ...
    def calculate_accumulated(self, *, include_regularization=False):
        ...
        # Calculate mean loss
        data_loss = self.accumulated_sum / max(self.accumulated_count,1)
        # If just data loss - return it
        if not include_regularization:
            return data_loss
        # Return the data and regularization losses
...
class Accuracy :
    ...
    def calculate_accumulated(self):
        ...
        # Calculate an accuracy
        accuracy = self.accumulated_sum / max(self.accumulated_count,1)
        # Return the data and regularization losses
        return accuracy
        ...
        for epoch in range(1, epochs + 1):
            ...
            for step in range(train_steps):
                ...
                if not step % print_every or step == train_steps - 1:
                    ...
                    'lr:' + str(self.optimizer.current_learning_rate))
            ...
            print('training, ' +
                'acc:' + str(epoch_accuracy)+
                'loss:' + str(epoch_loss)+
                'data_loss:' + str(epoch_data_loss) +
                'reg_loss:' + str(epoch_regularization_loss) +
                'lr:' +  str(self.optimizer.current_learning_rate))
            ...
            print(
            'validation, ' +
            'acc:' + str(validation_accuracy)+
            'loss:' + str(validation_loss) )
